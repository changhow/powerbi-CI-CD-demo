...
$pipelineName = "powerbi ci/cd demo"      # The name of the pipeline
$stageOrder = 0                     # The order of the source stage. Development (0), Test (1).

$datasetName = "titanic_analysis"       # The name of the dataset to be deployed
$reportName = "titanic_analysis"        # The name of the report to be deployed
